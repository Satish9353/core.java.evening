	...
	<nav class="navbar navbar-expand-sm bg-dark"
		...
		<div>
			<img height="50px"
				...
				<a href=sign.jsp id="admin"><button type="submit"
					class="btn btn-primary button">LogOut</button></a>
				<a href="home.jsp"><button
					type="button" class="btn btn-primary button">Home</button></a>
					
					<a href=information.jsp><button type="button"
					class="btn btn-primary button">Parking Info</button></a> 
					
					
				
				<a href="View.jsp"><button type="button"
					class="btn btn-primary button">View</button></a> 
			<%-- <p style= color:white>${dto.adminName}</p>
			 --%>
